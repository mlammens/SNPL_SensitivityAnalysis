...
ggsave( file="~/Dropbox/Projects/Sensitivity-Analysis/Aiello-Lammens-Akcakaya-SA/document/ConBio-Sub-2/figures/figure-s2.pdf", width=6.5, height=6.5, units="in" )
...
info_recovery <-
  ...
  summarise(mean_cor = mean(cor.val),
            sd_cor = sd(cor.val))
write.csv(info_recovery, file = "ema_info_recovery.csv", row.names = FALSE)
